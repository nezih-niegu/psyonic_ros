...
setup(
    ...
    install_requires=["setuptools", "mujoco", "mediapipe", "opencv-python",
                      "glfw", "plotly", "scipy"],
    zip_safe=True,
    ...
    entry_points={
        "console_scripts": [
            ...
            "session_recorder = ah_mujoco.session_recorder_node:main",
            "session_report = ah_mujoco.session_report:main",
