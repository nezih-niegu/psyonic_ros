    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "js_publisher",
                default_value="True",
                description="Publish Joint States (required for the viewer)",
                choices=["True", "False"],
            ),
            DeclareLaunchArgument(
                "simulated_hand",
            ...
            # MuJoCo viewer replaces joint_state_publisher + robot_state_publisher + RViz
            Node(
                package="ah_mujoco",
